// Runnable check for the shim's dispatch translation (translateLuaDispatch).
//
//   node tests/dispatch.mjs
//
...
const src = readFileSync(new URL("../shims/Quickshell/Hyprland/Hyprland.qml", import.meta.url), "utf8");
...
const root = {
    ...
    monitors: { values: [] },
    rawSpaces: Array.from({ length: 10 }),
    shortcuts: {},
};
